...
import { BookmarkSVG, deleteIcon } from "@assets/index";
    ...
    <>
      <div className="rounded-3xl border p-1">
        <div className="bg-gray-100 rounded-3xl p-4">
          ...
          <div className="flex flex-wrap md:flex-nowrap gap-1 mt-4">
            <div className="flex items-center bg-white rounded-full px-2 py-2 gap-1">
              <svg
              ...
              <p className="text-secondary sm:text-sm text-xs font-medium pt-[1px] whitespace-nowrap">
                ...
                <span className="text-gray-700 text-xs">/ {item?.payType}</span>
              </p>
            </div>
